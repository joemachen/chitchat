...
**Current state (v3.5.2):** Rooms, DMs, presence, Acrophobia (AcroBot), Prof Frink trivia, Homer quotes, System Events, room roles, message cache, private user data, room aliases. Themes, typing indicators, link previews, inline reply, edit/delete, reactions, search, export, audit log.
